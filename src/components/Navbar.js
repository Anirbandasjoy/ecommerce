  ...
  return (
    <nav className='navbar'>
      ...
      <div className='navbar__search'>
        ...
        <button className='search' type='submit'><FaSearchengin /> </button>
      </div>
      <div className='navbar__menu'>
        ...
        <div className={`navbar__links ${isOpen ? 'active' : ''}`}>
          ...
          <a href='#'>FOOTER</a>
          {/* <a href='#'>Contact</a> */}
          <button className='navLogin' onClick={toggleLogin}>Login</button>
          <button className='navLogin'  onClick={toggleRegister}>Sign Up</button>
        </div>
      </div>
      <div className={`login-popup ${isLoginOpen ? 'active' : ''}`}>
        <form>
          <h2>Login</h2>
      ...
      <div className={`register-popup ${isRegisterOpen ? 'active' : ''}`}>
        <form>
          <h2>Sign Up</h2>
          <label htmlFor='username'>Username</label>
          <input type='text' id='username' />
